  ...
  return (
    <AppBar position="static">
      <Toolbar>
        ...
        {auth.isAuthenticated() && (
          <>
            <Link to={"/patients/" + auth.isAuthenticated().user._id}>
              <Button style={isActive(location, "/patients/" + auth.isAuthenticated().user._id)}>Patient Management</Button>
            </Link>
            <Link to="/appointments/">
              <Button style={isActive(location, "/appointments" + auth.isAuthenticated().user._id)}>Appointment Scheduling</Button>
            </Link>
            <Link to="/dentists">
              <Button style={isActive(location, "/dentists" + auth.isAuthenticated().user._id)}>Dentist Profiles</Button>
            </Link>
            <Link to="/invoices">
              <Button style={isActive(location, "/invoices" + auth.isAuthenticated().user._id)}>Invoices</Button>
            </Link>
            <Link to="/treatmentplans">
              <Button style={isActive(location, "/treatmentplans" + auth.isAuthenticated().user._id)}>Treatment Plan</Button>
            </Link>
            <Link to={"/user/" + auth.isAuthenticated().user._id}>
              <Button style={isActive(location, "/user/" + auth.isAuthenticated().user._id)}>My Profile</Button>
            </Link>
