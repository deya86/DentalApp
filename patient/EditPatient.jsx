...
// export default function EditPatient() {
//   const classes = useStyles();
//   const { patientId } = useParams(); // Ensure that patientId is captured correctly
//   const [values, setValues] = useState({
//     firstName: '',
//     lastName: '',
//     dateOfBirth: '',
...
//     if (patientId) {
//       console.log('Fetching patient data for ID:', patientId); // Log patientId to ensure it's correct

//       readPatient({ patientId }, { t: jwt.token }, signal).then((data) => {
//         console.log('Received patient data:', data); // Log the received data
...
//         }
//       }).catch(error => {
//         console.error('Error fetching patient data:', error); // Log any error encountered during fetching
//       });
//     }
...
//     console.log('Updating patient:', patient); // Log the patient object
...
//       }
//     }).catch(error => {
//       console.error('Error updating patient data:', error); // Log any error encountered during updating
//     });
//   };
...
//             patientID: data.patientID || ''
//           });
//           console.log('Form values set:', values); // Log form values
//         } else {
...
export default function EditPatient() {
  ...
  if (values.navigateToProfile) {
    return (<Navigate to={'/patients/' + patientId} />);
  }
